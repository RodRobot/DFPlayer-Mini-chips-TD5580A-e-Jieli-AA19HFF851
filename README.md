...
O projeto foi desenvolvido para demonstrar uma forma simples de reproduzir arquivos MP3 utilizando o ESP32 sem precisar converter os áudios 
para arrays e armazená-los na memória do microcontrolador.
